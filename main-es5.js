(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                function AuthGuard(restaurangService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailComponent = /** @class */ (function () {
                function DetailComponent(activatedRoute, restaurangService) {
                ...
                DetailComponent.prototype.ngOnInit = function () {
                    ...
                    this.restaurangService.getRestaurang().subscribe(function (data) {
                        console.log(data);
                        _this.bokningsInfo = data;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var KontakterComponent = /** @class */ (function () {
                function KontakterComponent(activatedRoute, restaurangService) {
                    this.activatedRoute = activatedRoute;
                    this.restaurangService = restaurangService;
                }
                KontakterComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.restaurangId = Number(this.activatedRoute.snapshot.paramMap.get('id'));
                    console.log(this.restaurangId);
                    this.restaurangService.getRestaurang().subscribe(function (data) {
                ...
                return KontakterComponent;
            }());
            KontakterComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListComponent = /** @class */ (function () {
                function ListComponent(restaurangService) {
                    this.restaurangService = restaurangService;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(restaurangService, router, formBuilder) {
                    this.restaurangService = restaurangService;
                    this.router = router;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RestaurangServiceService = /** @class */ (function () {
                function RestaurangServiceService(http) {
                    this.http = http;
                }
                RestaurangServiceService.prototype.getRestaurang = function () {
                    console.log('getRestaurang');
                    return this.http.get('/assets/restauranger.json');
                };
                RestaurangServiceService.prototype.login = function (userInfo) {
                    // info om anvnamn är korrekt
                    localStorage.setItem('ACCESS_TOKEN', "access_token");
                };
                RestaurangServiceService.prototype.isLoggedIn = function () {
                    return localStorage.getItem('ACCESS_TOKEN') !== null;
                };
                RestaurangServiceService.prototype.logout = function () {
                    localStorage.removeItem('ACCESS_TOKEN');
                };
                return RestaurangServiceService;
            }());
            RestaurangServiceService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SchemaComponent = /** @class */ (function () {
                function SchemaComponent(activatedRoute, restaurangService) {
                    this.activatedRoute = activatedRoute;
                    this.restaurangService = restaurangService;
                }
            ...
            SchemaComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
                { type: _restaurang_service_service__WEBPACK_IMPORTED_MODULE_2__["RestaurangServiceService"] }
            ]; };
